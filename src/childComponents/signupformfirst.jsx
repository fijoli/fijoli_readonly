...
const SignUpFormFirst = () => {
  ...
  const registrationState = useSelector(
    (state) => state.storeComponent.registrationState
  );
  ...
  function IsValid() {
    ...
    return (
      registerInfo.user_name_status ||
      registerInfo.user_email_status ||
      registerInfo.whatsapp_number_status ||
      registerInfo.gender_status ||
      registerInfo.is_active_status
    );
  }
  ...
  return (
    <div className="signupformfirst-container">
      ...
      >
        ...
        >
          <TextField
            ...
            required
            helperText={
              regInfo.user_email_status ? "EmailId is incorrect." : ""
            }
            InputProps={{
              sx: { height: 40 },
              startAdornment: (
        ...
        >
          <TextField
            ...
            required
            helperText={
              regInfo.whatsapp_number_status
                ? "Whatsapp number is incorrect."
                : ""
            }
            InputProps={{
              sx: { height: 40 },
        ...
        >
          ...
          {regInfo.gender_status && <div>gender should be selected</div>}
        </Box>
        <Box
          sx={{
            height: "27px",
        ...
        >
          <label>
            <input type="checkbox" onChange={handleagreeChange} />I agree with
            Terms and Conditions
          </label>
          {regInfo.is_active_status && <div>confirm terms and conditions</div>}
        </Box>

        <div className="margin-field-Item">
          <button
            onClick={handleClickEvent}
            className="button_oval_style_signupfirst"
          >
            submit
          </button>
        </div>
      ...
      {
        <DisplayMessage
          displayState={displaymsg}
          handleclose={handlecloseDisplayMsg}
        />
      }
    </div>
  );
