...
const LoginComponent = () => {
  ...
  function IsValid() {
    ...
    return (
      validData.encrypted_password_status || validData.whatsapp_number_status
    );
  }
      ...
      <div className="login-container">
        ...
        <div className="login-container-box">
          ...
          <TextField
            ...
            helperText={
              loginData.whatsapp_number_status
                ? "Whatsapp Number is not correct or not entered"
                : ""
            }
            InputProps={{
              sx: { height: 40 },
          ...
          <div className="credential-Item">
            <TextField
              ...
              helperText={
                loginData.encrypted_password_status
                  ? "password is not correct or not entered"
                  : ""
              }
              variant="outlined"
          ...
          <div>
            <button
              ...
              className="button_oval_style_login"
            >
              Login
            </button>
          </div>
