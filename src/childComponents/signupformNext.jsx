...
const SignUpFormNext = () => {
  ...
  useEffect(() => {
    ...
    setregistrantInfo({
      ...registrantInfo,
      user_name: regConfigInfo.profileData.user_name,
      whatsapp_user_name: regConfigInfo.profileData.whatsapp_user_name,
    });
  ...
  function IsValid() {
    ...
    if (registerinfo.createpwd === "") {
      ...
      registerinfo.confirmpwd === "" ||
      registerinfo.createpwd !== registerinfo.confirmpwd
    ) {
    ...
    return (
      registerinfo.createpwd_status ||
      registerinfo.confirmpwd_status ||
      registerinfo.location_status ||
      registerinfo.dob_status ||
      registerinfo.user_category_status
    );
  }
  ...
  const handleSelect = (evt) => {
    setregistrantInfo({
      ...registrantInfo,
      user_category: evt.target.value,
      user_category_status: false,
    });
  };
        ...
        >
          ...
          >
            <div className="text-align-items">
              <TextField
                placeholder="your username in whatsapp number"
                fullWidth
                sx={{
            ...
            <div className="text-align-items">
              <TextField
                type={createEyeValue ? "text" : "password"}
                fullWidth
                placeholder="Create a Password"
                helperText={
                  registrantInfo.createpwd_status ? "please input password" : ""
                }
                variant="outlined"
                onChange={(evt) => handleChangeName(evt, "createpwd")}
                sx={{
                  "& fieldset": { borderRadius: 33 },
                }}
                InputProps={{
            ...
            <div className="text-align-items">
              <TextField
                type={confirmEyeValue ? "text" : "password"}
                fullWidth
                placeholder="Confirm Password"
                helperText={
                  registrantInfo.confirmpwd_status ? "password mismatch" : ""
                }
                variant="outlined"
                onChange={(evt) => handleChangeName(evt, "confirmpwd")}
                sx={{
                  "& fieldset": { borderRadius: 33 },
                }}
                InputProps={{
            ...
            <div className="text-align-items">
              <TextField
                ...
                fullWidth
                helperText={
                  registrantInfo.location_status
                    ? "Please select the location"
                    : ""
                }
                placeholder="location"
                variant="outlined"
                onChange={(evt) => handleChangeName(evt, "location")}
                sx={{
                  "& fieldset": { borderRadius: 33 },
                }}
                InputProps={{
            ...
            <div className="text-align-items">
              <TextField
                ...
                helperText={
                  registrantInfo.dob_status
                    ? "You need to be minimum 18 years to register on fijoli"
                    : ""
                }
                variant="outlined"
                onChange={(evt) => handleChangeName(evt, "dob")}
                sx={{
                  "& fieldset": { borderRadius: 33 },
                }}
                InputProps={{
            ...
            <div className="text-align-items">
              <Select
                displayEmpty
                value={registrantInfo.user_category}
          ...
          >
            <div className="text-align-items">
              <button
                ...
                className="button_oval_style_submit-signform2"
              >
                Next
              </button>
            </div>

            <div className="indicator-container text-align-items">
              {lstofforms.map((_, idx) => {
                return (
                  <button
                    ...
                    onClick={null}
                    className={
                      0 === idx ? "indicator" : "indicator indicator-inactive"
                    }
                  />
                );
              })}
