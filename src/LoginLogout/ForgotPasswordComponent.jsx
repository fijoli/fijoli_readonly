...
const ForgotPasswordComponent = () => {
  ...
  const forgetpwdState = useSelector(
    (state) => state.storeComponent.forgetpwdState
  );
  ...
  useEffect(() => {
    if (undefined != forgetpwdState && 200 === forgetpwdState.status) {
      ...
      navigate(
        "/createpassword?whatsapp_number=" + forgetpwdData.whatsapp_number
      );
  ...
  function IsValid() {
    ...
    return (
      validState.whatsapp_number_status ||
      validState.user_email_status ||
      validState.dob_status
    );
  }
  ...
  return (
    <div className="forgetpassword_main_container">
      ...
      <div className="verified-container">
        <VerifiedUserIcon />
        <p>Please verify your account to update password</p>
      </div>
      <Stack
        direction={"column"}
        spacing={4}
      ...
      >
        ...
        >
          <TextField
            ...
            helperText={
              forgetpwdData.user_email_status ? "email id is not valid" : ""
            }
            sx={{
              marginTop: "-6px",
        ...
        >
          <TextField
            ...
            fullWidth
            helperText={
              forgetpwdData.whatsapp_number_status
                ? "whatsapp number is not entered"
                : ""
            }
            sx={{
              marginTop: "-6px",
        ...
        <div>
          <button
            ...
            className="button_oval_style_submit_forgetpwd"
          >
            Submit
          </button>
        </div>
